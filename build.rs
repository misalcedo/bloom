...
fn main() {
    ...
    let bindings = bindgen::Builder::default()
        ...
        .clang_arg("-Wall")
        .clang_arg("-Wextra")
        .clang_arg("-Wdeprecated-declarations")
        .clang_arg("-Wdivision-by-zero")
        .clang_arg("-Wimplicit-function-declaration")
        .clang_arg("-Wimplicit-int")
        .clang_arg("-Wpointer-arith")
        .clang_arg("-Wshorten-64-to-32")
        .clang_arg("-Wwrite-strings")
        .clang_arg("-Wmissing-noreturn")
        .clang_arg("-Wno-constant-logical-operand")
        .clang_arg("-Wno-long-long")
        .clang_arg("-Wno-missing-field-initializers")
        .clang_arg("-Wno-overlength-strings")
        .clang_arg("-Wno-parentheses-equality")
        .clang_arg("-Wno-self-assign")
        .clang_arg("-Wno-tautological-compare")
        .clang_arg("-Wno-unused-parameter")
        .clang_arg("-Wno-unused-value")
        .clang_arg("-Wunused-variable")
        .clang_arg("-Wextra-tokens")
