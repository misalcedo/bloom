Gem::Specification.new do |spec|
  ...
  spec.files       = Dir["target/release/lib/*"] + Dir["target/release/include/*"] + ["lib/bloom_ruby.rb", "lib/bloom_ffi.rb"]
  spec.extensions  = ["Rakefile"]
  spec.require_paths = ["lib", "target/release"]
